  ...
  window.lz = (function() {
    ...
    Node = (function(_super) {
      ...
      function Node(el, attributes) {
        ...
        if (attributes.$handlers) {
          ...
          for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
            _ref4 = _ref3[_i], name = _ref4.name, script = _ref4.script, args = _ref4.args, reference = _ref4.reference;
            name = name.substr(2);
      ...
      Node.prototype.applyConstraint = function(property, expression) {
        var bindexpression, bindings, scope, scopes, _i, _len, _ref1;

        if ((_ref1 = this.constraints) == null) {
          this.constraints = {};
        }
    ...
    Sprite = (function() {
      ...
      function Sprite(jqel, view) {
        this.animate = __bind(this.animate, this);        if (jqel == null) {
    ...
    dom = (function() {
      ...
      processSpecialTags = function(el, classattributes, defaulttype) {
        var args, attributes, child, children, handler, script, type, _i, _len, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;

        if ((_ref1 = classattributes.$types) == null) {
          classattributes.$types = {};
        }
        if ((_ref2 = classattributes.$methods) == null) {
          classattributes.$methods = {};
        }
        if ((_ref3 = classattributes.$handlers) == null) {
        ...
        children = (function() {
          ...
          for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
            child = _ref4[_i];
            if (child.nodeType === 1 && (_ref5 = child.localName, __indexOf.call(specialtags, _ref5) >= 0)) {
              _results.push(child);
            }
          }
          return _results;
        ...
        for (_i = 0, _len = children.length; _i < _len; _i++) {
          ...
          switch (child.localName) {
            case 'handler':
              ...
              type = (_ref5 = attributes.type) != null ? _ref5 : defaulttype;
              handler = {
    ...
    Class = (function() {
      ...
      function Class(el, classattributes) {
        var body, child, compilertype, extend, ignored, name, oldbody, processedChildren, _i, _len, _ref1;

        if (classattributes == null) {
          classattributes = {};
        }
        name = classattributes.name;
        extend = (_ref1 = classattributes["extends"]) != null ? _ref1 : classattributes["extends"] = 'view';
        ...
        lz[name] = function(instanceel, instanceattributes) {
          var attributes, children, key, parent, propname, val, value, viewel, _j, _len1, _ref2;
          ...
          if (!(viewel = (_ref2 = parent.sprite) != null ? _ref2.el : void 0)) {
            return parent;
          }
          if (body) {
    ...
    Layout = (function(_super) {
      ...
      function Layout(el, attributes) {
        var subview, subviews, _base, _i, _len, _ref1;
        ...
        if ((_ref1 = (_base = this.parent).layouts) == null) {
          _base.layouts = [];
        }
    ...
    SimpleLayout = (function(_super) {
      ...
      function SimpleLayout(el, attributes) {
        ...
        this.spacing = 10;
        this.inset = 10;
        if ((_ref1 = attributes.$types) == null) {
          attributes.$types = {};
        }
    ...
    Mouse = (function(_super) {
      ...
      function Mouse() {
        ...
        this.handle = __bind(this.handle, this);        this.x = 0;
        this.y = 0;
    ...
    Keyboard = (function(_super) {
      ...
      function Keyboard() {
        this.handle = __bind(this.handle, this);        $(document).on(keyboardEvents.join(' '), this.handle);
      }
